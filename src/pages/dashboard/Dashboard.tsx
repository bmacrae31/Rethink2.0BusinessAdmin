...
import { Users, Gift, FileText, Tag, LayoutDashboard, Mail, UserCog } from 'lucide-react';
...
const getNavItems = (hasPermission: (perm: string) => boolean) => [
...
export default function Dashboard() {
  ...
  const navItems = getNavItems(hasPermission).filter(item => hasPermission(item.permission));
