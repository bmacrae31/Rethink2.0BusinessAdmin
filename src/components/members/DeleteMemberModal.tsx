                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to delete {member.name}'s account? This action cannot be
                        undone and will permanently remove all their data, including membership history
                        and rewards.
                      </p>
                    </div>
